...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """
        This function transforms data based on types of columns
        """
        
        try:
            numerical_columns = ['reading_score','writing_score',"math_score","science_score","total_score"]
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            numerical_columns = ["writing_score","reading_score","math_score","science_score","total_score"]
